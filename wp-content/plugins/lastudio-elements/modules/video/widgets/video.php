<?php
namespace Lastudio_Elements\Modules\Video\Widgets;
 ...
 * Video Widget
 */
class Video extends Lastudio_Widget {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Video Player', 'lastudio-elements' );
    }
    ...
    public function get_script_depends() {
        if ( \Lastudio_Elements\LastudioPlugin::instance()->in_elementor() ) {
            return array( 'mediaelement', 'lastudio-elements' );
        }
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'lastudio-elements/video/css-scheme',
            array(
        ...
        $this->start_controls_section(
            'section_video',
            array(
                'label' => esc_html__( 'Video', 'lastudio-elements' ),
            )
        );
        ...
        $this->add_control(
            'video_type',
            array(
                'label'   => esc_html__( 'Video Type', 'lastudio-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'youtube',
                'options' => array(
                    'youtube'     => esc_html__( 'YouTube', 'lastudio-elements' ),
                    'vimeo'       => esc_html__( 'Vimeo', 'lastudio-elements' ),
                    'self_hosted' => esc_html__( 'Self Hosted', 'lastudio-elements' ),
                ),
            )
        );
        ...
        $this->add_control(
            'youtube_url',
            array(
                'label'       => esc_html__( 'YouTube URL', 'lastudio-elements' ),
                'label_block' => true,
        ...
        $this->add_control(
            'vimeo_url',
            array(
                'label'       => esc_html__( 'Vimeo URL', 'lastudio-elements' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter your URL', 'lastudio-elements' ),
        ...
        $this->add_control(
            'self_hosted_player',
            array(
                'label'   => esc_html__( 'Player', 'lastudio-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'html5',
                'options' => array(
                    'html5' => esc_html__( 'Default HTML5', 'lastudio-elements' ),
                    'mejs'  => esc_html__( 'MediaElement Player', 'lastudio-elements' ),
                ),
                'condition' => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'raw'  => esc_html__( 'MediaElement Player support MP4 and WebM video formats', 'lastudio-elements' ),
        ...
        $this->add_control(
            'self_hosted_url',
            array(
                'label'      => esc_html__( 'Self Hosted URL', 'lastudio-elements' ),
        ...
        $this->add_control(
            'start_time',
            array(
                'label'       => esc_html__( 'Start Time (in seconds)', 'lastudio-elements' ),
                'label_block' => true,
        ...
        $this->add_control(
            'end_time',
            array(
                'label'       => esc_html__( 'End Time (in seconds)', 'lastudio-elements' ),
                'label_block' => true,
                'type'        => Controls_Manager::NUMBER,
                'condition' => array(
                    'loop' => '',
        ...
        $this->add_control(
            'aspect_ratio',
            array(
                'label'   => esc_html__( 'Aspect Ratio', 'lastudio-elements' ),
                'type'    => Controls_Manager::SELECT,
                'default' => '16-9',
                'options' => array(
                    '16-9' => '16:9',
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Video Options', 'lastudio-elements' ),
        ...
        $this->add_control(
            'mute',
            array(
                'label'   => esc_html__( 'Mute', 'lastudio-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
            )
        );
        ...
        $this->add_control(
            'controls',
            array(
                'label'     => esc_html__( 'Player Controls', 'lastudio-elements' ),
                'type'      => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'yt_modestbranding',
            array(
                'label'     => esc_html__( 'Modest Branding', 'lastudio-elements' ),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => '',
                'condition' => array(
                    'video_type' => 'youtube',
        ...
        $this->add_control(
            'yt_info',
            array(
                'label'     => esc_html__( 'Info', 'lastudio-elements' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__( 'Show', 'lastudio-elements' ),
                'label_off' => esc_html__( 'Hide', 'lastudio-elements' ),
                'default'   => '',
        ...
        $this->add_control(
            'yt_suggested_videos',
            array(
                'label'     => esc_html__( 'Suggested Videos', 'lastudio-elements' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__( 'Show', 'lastudio-elements' ),
                'label_off' => esc_html__( 'Hide', 'lastudio-elements' ),
                'default'   => '',
        ...
        $this->add_control(
            'yt_privacy_mode',
            array(
                'label'       => esc_html__( 'Privacy Mode', 'lastudio-elements' ),
                'type'        => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'lastudio-elements' ),
                'default'     => '',
                'condition'   => array(
                    'video_type' => 'youtube',
                ),
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Controls Color', 'lastudio-elements' ),
        ...
        $this->add_control(
            'mejs_controls',
            array(
                'label'       => esc_html__( 'Controls Visibility', 'lastudio-elements' ),
                'label_block' => true,
                'type'        => Controls_Manager::SELECT2,
                'multiple'    => true,
                'options' => array(
                    'current'    => esc_html__( 'Current Time', 'lastudio-elements' ),
                    'duration'   => esc_html__( 'Duration Time', 'lastudio-elements' ),
                    'volume'     => esc_html__( 'Volume', 'lastudio-elements' ),
                    'fullscreen' => esc_html__( 'Fullscreen Button', 'lastudio-elements' ),
                ),
        ...
        $this->add_control(
            'download_button',
            array(
                'label'       => esc_html__( 'Download Button', 'lastudio-elements' ),
                'description' => esc_html__( 'If browser supports', 'lastudio-elements' ),
                'type'        => Controls_Manager::SWITCHER,
                'label_on'    => esc_html__( 'Show', 'lastudio-elements' ),
                'label_off'   => esc_html__( 'Hide', 'lastudio-elements' ),
                'default'     => '',
        ...
        $this->add_control(
            'poster',
            array(
                'label' => esc_html__( 'Poster', 'lastudio-elements' ),
                'type'  => Controls_Manager::MEDIA,
                'condition' => array(
                    'video_type' => 'self_hosted',
                ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Thumbnail Overlay', 'lastudio-elements' ),
            )
        );
        ...
        $this->add_control(
            'show_thumbnail',
            array(
                'label'   => esc_html__( 'Show Custom Thumbnail', 'lastudio-elements' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
            )
        );
        ...
        $this->add_control(
            'thumbnail',
            array(
                'label' => esc_html__( 'Thumbnail', 'lastudio-elements' ),
                'type'  => Controls_Manager::MEDIA,
                'condition' => array(
                    'show_thumbnail' => 'yes',
                ),
        ...
        $this->add_control(
            'overlay_color',
            array(
                'label' => esc_html__( 'Overlay Color', 'lastudio-elements' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->start_controls_section(
            'section_play_button',
            array(
                'label' => esc_html__( 'Play Button', 'lastudio-elements' ),
            )
        );
        ...
        $this->add_control(
            'show_play_button',
            array(
                'label' => esc_html__( 'Show Play Button', 'lastudio-elements' ),
                'type'  => Controls_Manager::SWITCHER,
                'default' => 'yes',
            )
        );
        ...
        $this->add_control(
            'play_button_type',
            array(
                'label'   => esc_html__( 'Play Button Type', 'lastudio-elements' ),
                'type'    => Controls_Manager::CHOOSE,
                'default' => 'icon',
                'toggle'  => false,
                'options' => array(
                    'icon' => array(
                        'title' => esc_html__( 'Icon', 'lastudio-elements' ),
                        'icon'  => 'fa fa-play',
                    ),
                    'image' => array(
                        'title' => esc_html__( 'Image', 'lastudio-elements' ),
        ...
        $this->add_responsive_control(
            'play_button_size',
            array(
                'label' => esc_html__( 'Icon/Image Size', 'lastudio-elements' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 10,
        ...
        $this->add_control(
            ...
            array(
                'label'      => esc_html__( 'Image Border Radius', 'lastudio-elements' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Player Controls Container', 'lastudio-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'video_type' => 'self_hosted',
                    'self_hosted_player' => 'mejs',
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Player Play-Pause Button and Time', 'lastudio-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'video_type' => 'self_hosted',
                    'self_hosted_player' => 'mejs',
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Player Progress', 'lastudio-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'video_type' => 'self_hosted',
                    'self_hosted_player' => 'mejs',
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Player Volume', 'lastudio-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'video_type' => 'self_hosted',
                    'self_hosted_player' => 'mejs',
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Player Fullscreen Button', 'lastudio-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'video_type' => 'self_hosted',
                    'self_hosted_player' => 'mejs',
