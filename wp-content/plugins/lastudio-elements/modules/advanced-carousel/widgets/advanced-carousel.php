        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'custom-1'  => esc_html__( 'Custom 01', 'lastudio-elements' ),
                    'custom-2'  => esc_html__( 'Custom 02', 'lastudio-elements' ),
                    'custom-3'  => esc_html__( 'Custom 03', 'lastudio-elements' ),
                    'custom-4'  => esc_html__( 'Custom 04', 'lastudio-elements' ),
                    'custom-5'  => esc_html__( 'Custom 05', 'lastudio-elements' ),
                    'custom-6'  => esc_html__( 'Custom 06', 'lastudio-elements' ),
                    'custom-7'  => esc_html__( 'Custom 07', 'lastudio-elements' ),
                    'custom-8'  => esc_html__( 'Custom 08', 'lastudio-elements' ),
                ),
                'condition' => array(
                    'item_layout' => 'banners',
                ),
