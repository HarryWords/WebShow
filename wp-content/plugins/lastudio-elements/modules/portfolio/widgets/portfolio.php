...
use Lastudio_Elements\Modules\QueryControl\Module as Module_Query;
...
class Portfolio extends Lastudio_Widget {
    ...
    protected function _register_controls() {
                ...
                'fields_options' => [
                    'post_type' => [
                        ...
                        'options' => [
                            ...
                            'la_portfolio' => __( 'Latest Portfolio', 'lastudio-elements' ),
                    ...
                    'exclude' => [
                        'options' => [
                            ...
                            'terms' => __( 'Portfolio Category', 'lastudio-elements' ),
                        ],
                    ],
                    'exclude_ids' => [
                    ...
                    'exclude_term_ids' => [
                        'label' => __( 'Portfolio Category', 'lastudio-elements' ),
        ...
        $this->add_control(
            'show_excerpt',
            array(
                'label'        => esc_html__( 'Show Excerpt?', 'lastudio-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'lastudio-elements' ),
                'label_off'    => esc_html__( 'No', 'lastudio-elements' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            ...
            array(
                'label'   => esc_html__( 'Custom Excerpt Length', 'lastudio-elements' ),
        ...
        $this->add_control(
            'show_category',
            array(
                'label'        => esc_html__( 'Show Category?', 'lastudio-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'lastudio-elements' ),
                'label_off'    => esc_html__( 'No', 'lastudio-elements' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            'show_divider',
            array(
                'label'        => esc_html__( 'Show Divider?', 'lastudio-elements' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'lastudio-elements' ),
                'label_off'    => esc_html__( 'No', 'lastudio-elements' ),
                'return_value' => 'true',
        ...
        $this->add_control(
            'read_more_label',
            array(
                'label'   => esc_html__( '`Read More` Text', 'lastudio-elements' ),
                'type'    => Controls_Manager::TEXT,
        ...
        $this->start_controls_section(
            'section_filter_bar',
            [
                'label' => __( 'Filter Bar', 'lastudio-elements' ),
                'tab' => Controls_Manager::TAB_CONTENT,
                'condition' => array(
                    'layout_type!' => array(
                        'grid',
        ...
        $this->add_control(
            'category_filters',
            [
                'label' => __( 'Category Filters', 'lastudio-elements' ),
        ...
        $this->add_control(
            'category_order',
            array(
                'label'   => esc_html__( 'Category Order', 'lastudio-elements' ),
                'type'    => Controls_Manager::NUMBER,
                'min'     => 1,
                'max'     => 6,
                'step'    => 1,
        ...
        $this->add_control(
            'divider_order',
            array(
                'label'   => esc_html__( 'Divider Order', 'lastudio-elements' ),
                'type'    => Controls_Manager::NUMBER,
                'min'     => 1,
                'max'     => 6,
                'step'    => 1,
    ...
    public function generate_setting_json() {
        ...
        $settings = array(
            ...
            'perPage'               => $module_settings['query_posts_per_page'],
        );
