...
class Team_Member extends Lastudio_Widget {
    ...
    protected function _register_controls() {
        ...
        $css_scheme = apply_filters(
            ...
            array(
                ...
                'desc'              => '.lastudio-team-member .lastudio-team-member__desc',
    ...
    protected function maybe_apply_carousel( $shortcode_obj = null, $settings = array() ){
        if( $shortcode_obj instanceof \Lastudio_Elements\Shortcodes\Team_Member ) {

            if ( 'yes' !== $settings['carousel_enabled'] ) {
                $shortcode_obj->_slider_options = false;
            }
            else{
                ...
                $shortcode_obj->_slider_options = $options;
            }
    ...
    protected function render() {
        ...
        $this->maybe_apply_carousel( $shortcode_obj, $settings );
