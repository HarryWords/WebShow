...
class LastudioPlugin {
	...
	private function __override_js_file(){
        ...
        if(defined('ELEMENTOR_VERSION')){
            ...
            $opt_name = 'lastudio-elementor-has-init-js-' . ELEMENTOR_VERSION;
            if(!get_option($opt_name, false)){
                try{
                    $editor_target = ELEMENTOR_ASSETS_PATH . 'js/editor.min.js';
                    $editor_fake = LASTUDIO_ELEMENTS_PATH . 'override/assets/js/editor.min.js';
                    ...
                    $string_replace = array(
                        'this.stylesheet.addDevice("mobile",0).addDevice("tablet",e.md).addDevice("laptop",e.lg).addDevice("desktop",e.xl)',
