<?php
/*
Plugin Name:    Raz Package Demo Data
...
class Raz_Data_Demo_Plugin_Class{
    ...
    public static $theme_name = 'raz';

    public static $demo_site = 'https://raz.la-studioweb.com/';
...
add_action('plugins_loaded', function(){
    ...
    if(strtolower($theme->get_template()) != 'raz'){

        add_action( 'admin_notices', function(){
            printf( __( '%1$s"RAZ Package Demo Data" requires %3$s"RAZ"%4$s theme to be installed and activated. Please active %3$s"RAZ"%4$s to continue.%2$s', 'lastudio-demodata' ), '<div class="error"><p>', '</p></div>' ,'<strong>', '</strong>' );
        });
    ...
    Raz_Data_Demo_Plugin_Class::get_instance();
});