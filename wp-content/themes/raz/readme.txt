...
Tested up to: WordPress 5.1.1, WooCommerce 3.6.2
Version: 1.0.0
...
Online documentation: http://docs.la-studioweb.com/raz/
...
3. For the file upload, pick Theme Files / raz.zip in the theme package downloaded from ThemeForest and click Install Now.
...
------------ Version 1.0 Release [May 05, 2019]  ------------
* Release
