...
echo '<div class="post-meta">';
    ...
    lastudio_elements_utility()->get_date( array(
		...
		'icon'    => '',
		'html'    => '<span class="post__date post-meta__item"><i class="dlicon ui-2_time"></i>%1$s<a href="%2$s" %3$s %4$s ><time datetime="%5$s" title="%5$s">%6$s%7$s</time></a></span>',
		'echo'    => true,
	), get_the_ID());
    ...
    lastudio_elements_utility()->get_comment_count( array(
		...
		'icon'    => '',
		'prefix'  => esc_html__( 'Comments: ', 'raz' ),
