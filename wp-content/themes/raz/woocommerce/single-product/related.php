...
if ( $related_products ) : ?>
	...
	$product_cols = shortcode_atts(
		...
		Raz()->settings()->get('related_products_columns')
	);
	...
	$title = Raz()->settings()->get('related_product_title') ? Raz()->settings()->get('related_product_title') : _x( 'Related Products', 'front-view', 'raz' );
	$sub_title = Raz()->settings()->get('related_product_subtitle') ? Raz()->settings()->get('related_product_subtitle') : '';
