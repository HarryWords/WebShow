...
if ( $upsells ) : ?>
    ...
    $product_cols = shortcode_atts(
        ...
        Raz()->settings()->get('upsell_products_columns')
    );
    ...
    $title = Raz()->settings()->get('upsell_product_title') ? Raz()->settings()->get('upsell_product_title') : _x( 'You may also like&hellip;', 'front-view', 'raz' );
    $sub_title = Raz()->settings()->get('upsell_product_subtitle') ? Raz()->settings()->get('upsell_product_subtitle') : '';
