...
$catalog_column = Raz()->settings()->get('woocommerce_catalog_columns', Raz()->settings()->get('woocommerce_shop_page_columns'));
...
$catalog_class[] = raz_render_grid_css_class_from_columns($catalog_column);

if ( raz_wc_product_loop() ) {
