...
function raz_options_section_page_title_bar_auto_detect( $key = 'default', $desc = '', $dependency = array() ){
    ...
    $base_options = array(
        array(
            ...
            'type'          => 'responsive',
            'title'         => esc_html_x('Page Title Font Size', 'admin-view', 'raz'),
            'info'          => esc_html_x('Enter the font size (e.g: 20px )', 'admin-view', 'raz'),
            'desc'          => $desc,
        ),
        array(
            'id'        => $key_allows[$key]['key'] . 'page_title_bar_background',
            'type'      => 'background',
            'title'     => esc_html_x('Background', 'admin-view', 'raz'),
        ...
        array(
            ...
            'type'      => 'color_picker',
            'default'   => empty($dependency) ? Raz_Options::get_color_default('header_color') : '',
        ...
        array(
            ...
            'type'      => 'color_picker',
            'default'   => empty($dependency) ? Raz_Options::get_color_default('body_color') : '',
        ...
        array(
            ...
            'type'      => 'color_picker',
            'default'   => empty($dependency) ? Raz_Options::get_color_default('body_color') : '',
            'title'     => esc_html_x('Link Color', 'admin-view', 'raz'),
            'dependency'=> $dependency,
            'desc'      => $desc
        ),
        array(
            ...
            'type'      => 'color_picker',
            'default'   => empty($dependency) ? Raz_Options::get_color_default('primary_color') : '',
            'title'     => esc_html_x('Link Hover Color', 'admin-view', 'raz'),
            'dependency'=> $dependency,
            'desc'      => $desc
        ),
        array(
            ...
            'type'      => 'spacing',
            'title'     => esc_html_x('Spacing', 'admin-view', 'raz'),
            'dependency'=> $dependency,
            'desc'      => $desc,
            'unit' 	    => 'px',
            'default'   => array(
        ...
        array(
            ...
            'title'     => esc_html_x('Spacing', 'admin-view', 'raz'),
            'dependency'=> $dependency,
            'desc'      => $desc . esc_html_x(' on Desktop Small', 'admin-view', 'raz'),
            'unit' 	    => 'px',
            'default'   => array(
                'top' => empty($dependency) ? 40 : '',
                'bottom' => empty($dependency) ? 40 : ''
        ...
        array(
            ...
            'title'     => esc_html_x('Spacing', 'admin-view', 'raz'),
            'dependency'=> $dependency,
            'desc'      => $desc . esc_html_x(' on Tablet', 'admin-view', 'raz'),
            'unit' 	    => 'px',
            'default'   => array(
        ...
        array(
            ...
            'title'     => esc_html_x('Spacing', 'admin-view', 'raz'),
            'dependency'=> $dependency,
            'desc'      => $desc . esc_html_x(' on Mobile', 'admin-view', 'raz'),
            'unit' 	    => 'px',
            'default'   => array(
                'top' => empty($dependency) ? 25 : '',
                'bottom' => empty($dependency) ? 25 : ''
...
function raz_options_section_page_title_bar( $sections ) {

    $page_title_layout = array(
        'hide' => esc_html_x('Do not display', 'admin-view', 'raz')
    );
    $page_title_layout = $page_title_layout + Raz_Options::get_config_page_title_bar_opts(false);

    $desc_prefix = array(
        'woocommerce' => esc_html_x('WooCommerce', 'admin-view', 'raz'),
        'single_product' => esc_html_x('Single Product', 'admin-view', 'raz'),
        'single_post' => esc_html_x('Single Post', 'admin-view', 'raz'),
        'archive_portfolio' => esc_html_x('Archive Portfolio', 'admin-view', 'raz'),
        'single_portfolio' => esc_html_x('Single Portfolio', 'admin-view', 'raz')
    );

    $desc_for_default           = esc_html_x('For page title bar', 'admin-view', 'raz');
    ...
    $field_for_default = array_merge(
        array(
            array(
                ...
                'type'          => 'select',
                'class'         => 'chosen',
                'title'         => esc_html_x('Select Layout', 'admin-view', 'raz'),
            ...
            array(
                ...
                'title'         => esc_html_x('Replace breadcrumb by custom text', 'admin-view', 'raz'),
                'desc'          => $desc_for_default,
        ...
        raz_options_section_page_title_bar_auto_detect('default', $desc_for_default)
    );
    ...
    $child_sections[] = array(
        ...
        'title'     => esc_html_x('Global Page Title', 'admin-view', 'raz'),
        'icon'      => 'fa fa-cog',
    ...
    $field_for_woo = array_merge(
        array(
            array(
                ...
                'class'         => 'la-radio-style',
                'default'       => 'off',
                'title'         => esc_html_x('Enable Override', 'admin-view', 'raz'),
                'desc'          => esc_html_x('Turn on to override all setting page title bar of WooCommerce Settings ( Shop page / Product Category / Product Tags and Search page )', 'admin-view', 'raz'),
                'info'          => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'raz'),
            ...
            array(
                ...
                'type'          => 'select',
                'class'         => 'chosen',
                'title'         => esc_html_x('Page Title Bar Layout', 'admin-view', 'raz'),
                'desc'          => '[' . $desc_prefix['woocommerce'] . ']',
                'options'       => $page_title_layout,
                'dependency'    => array('woo_override_page_title_bar_on', '==', 'true')
            )
        ),
        raz_options_section_page_title_bar_auto_detect(
            'woocommerce',
            $desc_for_woo,
    ...
    $field_for_single_post = array_merge(
        array(
            array(
                ...
                'default'       => 'off',
                'title'         => esc_html_x('Enable Override', 'admin-view', 'raz'),
                'desc'          => esc_html_x('Turn on to override all setting page title bar of Post pages', 'admin-view', 'raz'),
                'info'          => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'raz'),
                'options'       => Raz_Options::get_config_radio_onoff(false)
            ),
            array(
    ...
    $field_for_single_product = array_merge(
        array(
            array(
                ...
                'default'       => 'off',
                'title'         => esc_html_x('Enable Override', 'admin-view', 'raz'),
                'desc'          => esc_html_x('Turn on to override all setting page title bar of Single Product', 'admin-view', 'raz'),
                'info'          => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'raz'),
                'options'       => Raz_Options::get_config_radio_onoff(false)
            ),
            array(
    ...
    $field_for_archive_portfolio = array_merge(
        array(
            array(
                ...
                'default'       => 'off',
                'title'         => esc_html_x('Enable Override', 'admin-view', 'raz'),
                'desc'          => esc_html_x('Turn on to override all setting page title bar of Archive Portfolio', 'admin-view', 'raz'),
                'info'          => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'raz'),
                'options'       => Raz_Options::get_config_radio_onoff(false)
            ),
            array(
    ...
    $field_for_single_portfolio = array_merge(
        array(
            array(
                ...
                'default'       => 'off',
                'title'         => esc_html_x('Enable Override', 'admin-view', 'raz'),
                'desc'          => esc_html_x('Turn on to override all setting page title bar of Single Portfolio', 'admin-view', 'raz'),
                'info'          => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'raz'),
                'options'       => Raz_Options::get_config_radio_onoff(false)
            ),
            array(
