...
if(!class_exists('Raz_MegaMenu_Walker')){

    class Raz_MegaMenu_Walker extends Walker_Nav_Menu {
        ...
        public function mega_start_el( &$output, $item, $depth=0, $args=array(),$current_object_id=0 ){
            ...
            if($depth == 0 && isset($item->menu_type) && $item->menu_type == "wide" && $this->has_children){
                $is_mega = true;
            }
            ...
            if ($depth == 0) {
                $popup_custom_styles = '';
                if ($item->menu_type == "wide" && $this->has_children) {
