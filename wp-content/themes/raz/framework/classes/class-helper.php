...
if(!class_exists('Raz_Helper')){
    ...
    class Raz_Helper{
        ...
        public static function render_background_atts($options, $echo = true){
            ...
            if($echo){
                echo raz_render_variable($return);
            }
            else{
                return $return;
            }
        ...
        public static function render_access_component( $type, $component = array(), $parent_name = '', $css_class = ''){
            ...
            if(!empty($component['text'])){
                $current_user_name = esc_html__('Guest', 'raz');
            ...
            switch($type){
                ...
                case 'text':
                    ...
                    if(!empty($component['text'])){
                        ...
                        $target_html .= apply_filters('raz/filter/component/text', $component['text']);
                        $target_html .= '</span>';
                        $target_html .= '</span>';
                    }
                    else{
                ...
                case 'link_text':
                    ...
                    if(!empty($component['text'])){
                        $icon_html .= '<span class="component-target-text">'. apply_filters('raz/filter/component/text', $component['text']) .'</span>';
                    }
                    $target_html = '<a rel="nofollow" class="component-target" href="'.$target_url.'">'.$icon_html.'</a>';
                    break;
        ...
        public static function is_enable_image_lazy(){
            return apply_filters('raz/image/use_lazy_load', true);
        }
