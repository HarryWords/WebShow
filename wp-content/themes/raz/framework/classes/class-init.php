...
class Raz_Init{
    ...
    public function load_textdomain(){
        load_theme_textdomain( 'raz', Raz::$template_dir_path . '/languages' );
        load_child_theme_textdomain( 'raz', Raz::$stylesheet_dir_path . '/languages' );
    }
    ...
    public function add_theme_supports(){
        ...
        if(Raz()->settings()->get('woocommerce_gallery_zoom') == 'yes'){
            add_theme_support( 'wc-product-gallery-zoom');
        }
        if(Raz()->settings()->get('woocommerce_gallery_lightbox') == 'yes'){
        ...
        add_theme_support( 'editor-color-palette', array(
            array(
                'name' => esc_attr_x( 'theme primary', 'admin-view', 'raz' ),
                'slug' => 'raz-theme-primary',
                'color' => '#fc4f4f',
            ),

            array(
                'name' => esc_attr_x( 'theme secondary', 'admin-view', 'raz' ),
                'slug' => 'raz-theme-secondary',
                'color' => '#2F2F2F',
            ),

            array(
                'name' => esc_attr_x( 'strong magenta', 'admin-view', 'raz' ),
                'slug' => 'strong-magenta',
                'color' => '#a156b4',
            ),
            array(
                'name' => esc_attr_x( 'light grayish magenta', 'admin-view', 'raz' ),
                'slug' => 'light-grayish-magenta',
                'color' => '#d0a5db',
            ),
            array(
                'name' => esc_attr_x( 'very light gray', 'admin-view',  'raz' ),
                'slug' => 'very-light-gray',
                'color' => '#eee',
            ),
            array(
                'name' => esc_attr_x( 'very dark gray', 'admin-view', 'raz' ),
                'slug' => 'very-dark-gray',
                'color' => '#444',
            ),
        ) );
        ...
        if($font_source == '1'){
            add_editor_style(raz_get_google_fonts_url());
        }
    ...
    public function register_sidebar(){
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Sidebar Widget Area', 'admin-view', 'raz' ),
            'id'            => 'sidebar-primary',
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Sidebar Shop Filter', 'admin-view', 'raz' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Aside Header Widget Area', 'admin-view', 'raz' ),
            'description'   => esc_attr_x( 'Content of Aside Header component', 'admin-view', 'raz' ),
            'id'            => 'aside-widget',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => '</div>',
            'before_title'  => '<h3 class="widget-title"><span>',
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Header Bottom Widget Area', 'admin-view', 'raz' ),
            'description'   => esc_attr_x( 'Apply for only header layout 4,5,6,7', 'admin-view', 'raz' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Top', 'admin-view', 'raz' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Inner Top', 'admin-view', 'raz' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Inner Bottom', 'admin-view', 'raz' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block Bottom', 'admin-view', 'raz' ),
        ...
        if(function_exists('dokan')){
            register_sidebar(
                array(
                    'name'          => esc_html__( 'Dokan Store Sidebar', 'raz' ),
                    'id'            => 'sidebar-store',
                    'before_widget' => '<div id="%1$s" class="widget %2$s">',
                    'after_widget'  => '</div>',
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Custom Block After Add To Cart', 'admin-view', 'raz' ),
            'description'   => esc_attr_x( 'Display custom block on single product page', 'admin-view', 'raz' ),
        ...
        register_sidebar(array(
            'name'          => esc_attr_x( 'Single Product Custom Block Summary', 'admin-view', 'raz' ),
            'description'   => esc_attr_x( 'Display custom block on single product page', 'admin-view', 'raz' ),
            'id'            => 's-p-custom-summary',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => '</div>',
            'before_title'  => '<h3 class="widget-title"><span>',
            'after_title'   => '</span></h3>'
